...
# st.set_page_config(page_title="Flooded Machining",layout='wide')

st.title("Machining Cost Modelling Program")
st.write("This application enables you to calculate the total cost of flooded or scCO2 + MQL cooling")
st.write("Click side bar to select flooded or scCO2+MQL calculations")
st.write("Click the 'Cost bar chart' tab to display associated cost bar chart")
st.markdown("---")
...
tab1, tab2 = st.tabs(["Cost calculator", "Cost bar chart"])
